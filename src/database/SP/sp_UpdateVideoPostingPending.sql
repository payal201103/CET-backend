CREATE OR ALTER PROCEDURE [dbo].[sp_UpdateVideoPostingPending]
(
    @Id INT,
    @IsActive BIT
)
...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            RAISERROR('Pending video posting request not found.', 16, 1);
            RETURN;
        END
        ...
        BEGIN
            ...
            INSERT INTO dbo.video_posting_completed (
                id,
                jobCardNo,
                customerName,
                carDetails,
            ...
            DELETE FROM dbo.video_posting_pending
            WHERE id = @Id;
